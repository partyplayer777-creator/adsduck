...
const categoryActiveStyle = {
  ...
  "게임 이벤트": "bg-amber-400 text-gray-950 border-amber-400",
...
export default function ContestList({ contests, onSelect, bookmarks, onToggleBookmark, onToast }) {
  ...
  const categoryIcons = {
    ...
    "게임 이벤트": "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.168 3.595a1 1 0 00.95.69h3.78c.969 0 1.371 1.24.588 1.81l-3.058 2.222a1 1 0 00-.364 1.118l1.168 3.595c.3.921-.755 1.688-1.539 1.118l-3.058-2.222a1 1 0 00-1.176 0l-3.058 2.222c-.783.57-1.838-.197-1.539-1.118l1.168-3.595a1 1 0 00-.364-1.118L4.56 9.022c-.783-.57-.38-1.81.588-1.81h3.78a1 1 0 00.95-.69l1.168-3.595z",
